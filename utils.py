...
async def send_all(bot, query,  userid, files, ident):
            ...
            try:
                await bot.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                            InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Pᴇʀsᴏɴ', url="https://t.me/HydraRFT"),
                            InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url="https://t.me/+HzGpLAZXTxoyYTNl")
                        ]
                        ]
                    )
                )
